    ...
    <div
      ...
      <div className="layout-container flex h-full grow flex-col">
        <header className="shadow-lg flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e8edf3] px-10 py-3 fixed w-full trans bg-white">
          ...
          <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 bg-[#e8edf3] text-[#0e141b] text-sm font-bold leading-normal tracking-[0.015em]">
